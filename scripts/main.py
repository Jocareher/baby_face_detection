...
def main():
    ...
    pretrained_model_url = config["MODEL"]["COCO-Detection/faster_rcnn_R_50_FPN_3x.yaml"]
    ...
    model_and_train_config = engine.setup_cfg(base_config_path=base_config_path,
    ...
    evaluator = train.FaceTrainer.build_evaluator(model_and_train_config, model_and_train_config.DATASETS.TEST)
    val_loader = build_detection_test_loader(model_and_train_config, model_and_train_config.DATASETS.TEST)
